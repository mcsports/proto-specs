...
type ListFriendsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TotalFriends  uint32                 `protobuf:"varint,1,opt,name=total_friends,json=totalFriends,proto3" json:"total_friends,omitempty"`
	Pages         uint32                 `protobuf:"varint,2,opt,name=pages,proto3" json:"pages,omitempty"`
	Friend        []*PlayerData          `protobuf:"bytes,3,rep,name=friend,proto3" json:"friend,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListFriendsResponse) GetTotalFriends() uint32 {
	if x != nil {
...
type ListFriendInvitesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TotalRequests uint32                 `protobuf:"varint,1,opt,name=total_requests,json=totalRequests,proto3" json:"total_requests,omitempty"`
	Pages         uint32                 `protobuf:"varint,2,opt,name=pages,proto3" json:"pages,omitempty"`
	Friend        []*PlayerData          `protobuf:"bytes,3,rep,name=friend,proto3" json:"friend,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListFriendInvitesResponse) GetTotalRequests() uint32 {
	if x != nil {
...
const file_mcsports_friend_v1_data_proto_rawDesc = "" +
	...
	"\rtotal_friends\x18\x01 \x01(\rR\ftotalFriends\x12\x14\n" +
	"\x05pages\x18\x02 \x01(\rR\x05pages\x126\n" +
	"\x06friend\x18\x03 \x03(\v2\x1e.mcsports.friend.v1.PlayerDataR\x06friend\"\xb2\x01\n" +
	...
	"\x05_pageB\t\n" +
	"\a_amount\"\x90\x01\n" +
	"\x19ListFriendInvitesResponse\x12%\n" +
	"\x0etotal_requests\x18\x01 \x01(\rR\rtotalRequests\x12\x14\n" +
	"\x05pages\x18\x02 \x01(\rR\x05pages\x126\n" +
	"\x06friend\x18\x03 \x03(\v2\x1e.mcsports.friend.v1.PlayerDataR\x06friend\"Q\n" +
